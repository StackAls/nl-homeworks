...
|------|-------------|------|---------|:--------:|
| <a name="input_analytics"></a> [analytics](#input\_analytics) | n/a | `string` | `"analytics"` | no |
...
| <a name="input_marketing"></a> [marketing](#input\_marketing) | n/a | `string` | `"marketing"` | no |
