...
short_description: This is my my_own_module

# If this is part of a collection, you need to use semantic versioning,
# i.e. the version is of the form "2.5.0" and not "2.4".
version_added: "1.0.0"

description: my_own_module writing file to specified path
...
options:
    path:
        ...
        type: str
    content:
        description: content wich would be writen to file on path
        required: true
        type: str
...
def run_module():
    ...
    module_args = dict(
        ...
        content=dict(type='str', required=False, default = "Content to file")
    )
